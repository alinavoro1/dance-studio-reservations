...
public abstract class Abonament implements Calculable{
    ...
    public void setSedinteRamase(int sedinte) { this.numarClase = sedinte; }
    public void setDataStart(java.time.LocalDate dataStart) { this.dataStart = dataStart; }
    public void setDataExpirare(java.time.LocalDate dataExpirare) { this.dataExpirare = dataExpirare; }
}
